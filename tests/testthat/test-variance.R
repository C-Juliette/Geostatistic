...
test_that("Regular test - variance of a constant dataframe", {
  # arrange
  Z <- matrix(rep(3, 5*5), nrow = 5) |> as.data.frame()
  # act
  actual <- variance(Z)
  # assert
  expected <- 0
...
test_that("Anomaly test - error when the parametre is a string", {
  # arrange
  # act & assert
  expect_error(variance("a"), "^M must be a number or a vector/matrix/dataframe of numbers$")
})

test_that("Anomaly test - error when the parametre is a vector of strings", {
  # arrange
  # act & assert
  expect_error(variance(c("a", "b", "c")), "^M must be a number or a vector/matrix/dataframe of numbers$")
})

test_that("Anomaly test - error when the parametre is a vector of string", {
  # arrange
  # act & assert
  expect_error(variance(c("2")), "^M must be a number or a vector/matrix/dataframe of numbers$")
})
...
test_that("Anomaly test - error when the parametre is a string", {
  # arrange
  # act & assert
  expect_error(variance("2"), "^M must be a number or a vector/matrix/dataframe of numbers$")
})
...
test_that("Anomaly test - error when the parametre is a function", {
  ...
  # act & assert
  expect_error(variance(f), "^M must be a number or a vector/matrix/dataframe of numbers$")
})
